package com.angkorteam.tomcat.google;
...
public class GoogleSSLUtil extends AbstractSSLUtilBase {
    ...
    public GoogleSSLUtil(SSLHostConfigCertificate certificate) {
        super(certificate);
    }
    ...
    public SSLContext createSSLContext(List<String> negotiableProtocols) throws NoSuchAlgorithmException {
        return new ExposeJSSESSLContext(sslHostConfig.getSslProtocol(), new OpenSSLProvider());
    }
